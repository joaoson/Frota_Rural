...
import type { AssinaturaEvidencia } from "@/features/contracts/types/contractDocument";
  ...
  return (
    <div className="evid-box">
      ...
      <div className="evid-row">
        ...
        <span className="evid-val">{formatarUtcCompleto(evidencia.assinado_em_utc)}</span>
      </div>
      <div className="evid-row">
