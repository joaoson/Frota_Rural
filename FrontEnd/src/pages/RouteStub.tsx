  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 pt-32 pb-20 px-6 max-w-[1200px] mx-auto w-full">
        <h1 className="font-headline text-2xl font-bold text-primary dark:text-primary-bright mb-4">{title}</h1>
        <p className="text-on-surface-variant text-sm mb-6">Esta página será implementada em breve.</p>
        <Link to="/" className="text-sm font-bold text-primary dark:text-primary-bright hover:underline">
          Voltar ao início
        </Link>
      </main>
      <Footer />
